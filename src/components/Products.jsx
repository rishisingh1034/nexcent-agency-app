...
const Products = () => {
  return (
    <div >
            {/* about text */}
            <div className="px-4 1g:px-14 max-w-screen-2x1 mx-auto my-8" id='product'>
            ...
            <div className="px-4 1g:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver py-16">
                <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                    ...
                    <div>
                        ...
                        <p className='text-base text-neutralSilver  mb-8'>British Dragon Boat Racing Association</p>
                        <div >
