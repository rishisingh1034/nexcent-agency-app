...
const About = () => {
    return (
        <div >
            {/* about text */}
            <div className="px-4 1g:px-14 max-w-screen-2x1 mx-auto my-8" id='about'>
                <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-14'>
                    <div>
                        <img src="src/assets/about.svg" alt="" height={500} width={500} />
                    </div>
            ...
            {/* company stats */}
            <div className="px-4 1g:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver py-16">
                    ...
                    <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
                        <div className='space-y-8'>
                            <div className='flex item-center gap-4'>
                                <img src="/src/assets/memberStat.svg" alt="" width={50} />
                                <div>
                            ...
                            <div className='flex item-center gap-4'>
                                <img src="/src/assets/clubStat.svg" alt="" width={50}/>
                                <div>
                        ...
                        <div className='space-y-8'>
                            <div className='flex item-center gap-4'>
                                <img src="/src/assets/eventStat.svg" alt="" width={50}/>
                                <div>
                            ...
                            <div className='flex item-center gap-4'>
                                <img src="/src/assets/paymentStat.svg" alt="" width={50}/>
                                <div>
