...
const Services = () => {
    ...
    const services = [
        ...
        {
            id:2, title:"National Associations",description:"Our membership management software provides full automation of membership renewals and payments",image:"src/assets/national.png"
        },
        {
            id:3, title:"Clubs And Groups",description:"Our membership management software provides full automation of membership renewals and payments",image:"src/assets/clubs.png"
        }
    ]

  return (
    <div className='md:14px px-4 py-16 max-w-screen-2xl mx-auto' id='service'>
